...
public class ServletUtility {
	...
	public static void setObject(Object object, HttpServletRequest request) {
	...
	// For redirect Request set attribute on session
	public static void setObjectOnSession(Object object, HttpServletRequest request) {
		request.getSession().setAttribute("object", object);
	}

	public static Object getObjectOnSession(HttpServletRequest request) {
		return request.getSession().getAttribute("object");
	}
	
	public static void removeObjectOnSession(HttpServletRequest request) {
